...
class Host extends Agent {
    ...
    public void update() {
        System.out.println("The update method is being called");
...
class PlagueSimulationView extends SimulationView {
    ...
    public PlagueSimulationView(PlagueSimulation s) {
        super(s);
        plg = s;
        plg.populate(); //everytime this is called, the populate method in your customized simulation class is called
    }

    public void paintComponent(Graphics gc) {
        System.out.println("the Plague paintcomponent is being called");
